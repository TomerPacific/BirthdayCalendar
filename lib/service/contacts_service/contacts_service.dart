...
abstract class ContactsService {
  ...
  Future<void> handleAddingBirthdaysToContacts(BuildContext context, List<Contact> contactsWithoutBirthDates);
  Future<List<Contact>> fetchContacts(bool withThumbnails);
  Future<void> addContactToCalendar(UserBirthday contact, BuildContext context);
}